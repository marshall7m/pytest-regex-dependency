def test_node_id_no_skip(base_tester):
    ...
    result.stdout.re_match_lines(
        r"""
        test_node_id_no_skip.py::test_a PASSED(?:\s+\(.*\))?
        .*::test_b PASSED(?:\s+\(.*\))?
        test_node_id_no_skip.py::TestClass::test_a PASSED(?:\s+\(.*\))?
        .*::test_c PASSED(?:\s+\(.*\))?
    """
    )
...
def test_node_id_skip(base_tester):
    ...
    result.stdout.re_match_lines(
        r"""
        test_node_id_skip.py::test_a SKIPPED(?:\s+\(.*\))?
        .*::test_b SKIPPED(?:\s+\(.*\))?
        test_node_id_skip.py::TestClass::test_a SKIPPED(?:\s+\(.*\))?
        .*::test_c SKIPPED(?:\s+\(.*\))?
    """
    )
...
def test_module_no_skip(base_tester):
    ...
    result.stdout.re_match_lines(
        r"""
        test_dependency.py::test_a PASSED(?:\s+\(.*\))?
        test_dependency.py::test_b PASSED(?:\s+\(.*\))?
        test_module_no_skip.py::test_a PASSED(?:\s+\(.*\))?
    """
    )
...
def test_module_skip(base_tester):
    ...
    result.stdout.re_match_lines(
        r"""
        test_dependency.py::test_a PASSED(?:\s+\(.*\))?
        test_dependency.py::test_b SKIPPED(?:\s+\(.*\))?
        test_module_skip.py::test_a SKIPPED(?:\s+\(.*\))?
    """
    )
...
def test_function_no_skip(base_tester):
    ...
    result.stdout.re_match_lines(
        ...
        test_dependency.py::test_a PASSED(?:\s+\(.*\))?
        test_dependency.py::test_b PASSED(?:\s+\(.*\))?
        test_function_no_skip.py::test_a PASSED(?:\s+\(.*\))?
        test_function_no_skip.py::test_b PASSED(?:\s+\(.*\))?
    """
    )
...
def test_function_skip(base_tester):
    ...
    result.stdout.re_match_lines(
        r"""
        test_dependency.py::test_a SKIPPED(?:\s+\(.*\))?
        test_dependency.py::test_b PASSED(?:\s+\(.*\))?
        test_function_skip.py::test_a PASSED(?:\s+\(.*\))?
        test_function_skip.py::test_b SKIPPED(?:\s+\(.*\))?
    """
    )
